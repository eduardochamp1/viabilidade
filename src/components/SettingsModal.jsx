      ...
      <div className="modal settings-modal" onClick={e => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="modal-form">
          ...
          <div className="form-group">
            ...
            <select value={form.provider} onChange={set('provider')}>
              <option value="copernicus">
                Copernicus Data Space (ESA — gratuito)
              </option>
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              <label>Camada Sentinel-1 SAR</label>
              <input
                type="text"
          ...
          <div className="settings-instructions">
            ...
            <ol>
              ...
              <li>
                Crie uma <strong>nova configuração</strong> e adicione as camadas:
                <br />
                • Sentinel-2 L2A → nomeie <code>TRUE_COLOR</code>
                <br />
                • Landsat 8-9 L2 → nomeie <code>TRUE_COLOR2</code>
                <br />
                • Sentinel-1 GRD → nomeie <code>SAR-RGB</code>
              </li>
              <li>
